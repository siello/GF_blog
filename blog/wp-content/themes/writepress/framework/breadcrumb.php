...
class writepress_bread_crumb{
public function writepress_breadcrumbs( $args = '' ) {

	$default = array(
		'type'				=> 'list',
		'home_label'		=> __( 'Home', 'writepress' ),
		'search_label'		=> __( 'Search Result of "%s"', 'writepress' ),
		'404_label'			=> __( '404 Not Found', 'writepress' ),
		'category_label'	=> _x( '%s', 'category label', 'writepress' ),
		'tag_label'			=> _x( '%s', 'tag label', 'writepress' ),
		'taxonomy_label'	=> _x( '%s', 'taxonomy label', 'writepress' ),
		'author_label'		=> _x( '%s', 'author label', 'writepress' ),
		'attachment_label'	=> _x( '%s', 'attachment label', 'writepress' ),
		'year_label'		=> _x( '%s', 'year label', 'writepress' ),
		'month_label'		=> _x( '%s', 'month label', 'writepress' ),
		'day_label'			=> _x( '%s', 'day label', 'writepress' ),
		'post_type_label'	=> _x( '%s', 'post type label', 'writepress' ),
		'joint_string'		=> __( '&gt; ', 'writepress' ),
		'navi_element'		=> '',
		'elm_class'			=> '',
		'elm_id'			=> 'crumbs',
		'li_class'			=> '',
...
$writepress_bread_crumb = new writepress_bread_crumb();

if ( ! function_exists( 'writepress_breadcrumbs' ) ) {
function writepress_breadcrumbs( $args = '' ) {
	global $writepress_bread_crumb;
	return $writepress_bread_crumb->writepress_breadcrumbs( $args );
}
}
/* Breadcumb End */