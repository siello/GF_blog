  ...
  <div class="zolo-header-area header_background zolo_preset_header6 <?php echo esc_attr($zolo_header_sticky);?>"> 
    ...
    <div class="zolo-topbar">
      <div class="headertopcontent_box">
		...
		// Header Email
		if($writepress_data["header_email"]){
			echo '<li class="top-mail"><i class="fa fa-envelope mail-icon"></i><a href="mailto:'.esc_attr($writepress_data["header_email"]).'">'.esc_attr($writepress_data["header_email"]).'</a></li>';		
		}
		// Header Phone Number
		if($writepress_data["header_number"]){
			echo '<li class="top-phone"><i class="fa fa-phone mail-icon"></i><a href="tel:'.esc_attr($writepress_data["header_number"]).'">'.esc_attr($writepress_data["header_number"]).'</a></li>';	
		}
		echo '</ul></div>'; 
        //Topbar Right
	...
	echo '<div class="header_right"><ul class="header_right_col">'; 
			...
			// Header Ad Area
			if($writepress_data["header_ad_section"]){
				echo '<li class="header_ad">'.wp_kses($writepress_data["header_ad_section"],array(
          'span' => array(
           'class' => array(),
          ),
          'i' => array(
