 <?php global $writepress_data; 
 $target = '_blank';
 ?>
 
 <?php if($writepress_data['facebook_link'] || $writepress_data['flickr_link'] || $writepress_data['rss_link'] || $writepress_data['twitter_link'] || $writepress_data['vimeo_link'] || $writepress_data['youtube_link'] || $writepress_data['instagram_link'] || $writepress_data['pinterest_link'] || $writepress_data['tumblr_link'] || $writepress_data['google_link'] || $writepress_data['dribbble_link'] || $writepress_data['digg_link'] || $writepress_data['linkedin_link'] || $writepress_data['skype_link'] || $writepress_data['deviantart_link'] || $writepress_data['yahoo_link'] || $writepress_data['reddit_link'] || $writepress_data['dropbox_link'] || $writepress_data['soundcloud_link'] || $writepress_data['vk_link'] || $writepress_data['email_link']){ 
 
if($writepress_data['header_social_links_boxed'] == 'Yes'){
...
?><ul class="social-icon">
        <?php if($writepress_data['facebook_link']): ?>
        ...
        <?php if($writepress_data['vimeo_link']): ?>
        ...
        <?php if($writepress_data['youtube_link']): ?>
        ...
        <?php if($writepress_data['instagram_link']): ?>
        ...
        <?php if($writepress_data['pinterest_link']): ?>
        ...
        <?php if($writepress_data['dribbble_link']): ?>
        ...
        <?php if($writepress_data['soundcloud_link']): ?>
